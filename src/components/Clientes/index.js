...
function Clientes() {
    ...
    const campos = [
        { label: 'Nombre cliente', placeholder: 'Ingrese el nombre del cliente', required: true, name: 'NombreEmpleado', type: 'text', classname: 'col-md-4' },
        { label: 'Apellido cliente', placeholder: 'Ingrese el Apellido del cliente', required: true, name: 'NombreEmpleado', type: 'text', classname: 'col-md-4' },
            ...
            <Card>
                <div className='row'>
                    <div className='col-md-8'>
                        <Card title='Data Maestra Clientes'>
